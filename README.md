...
- [GraphQL Service Interacting with downstream Services]() – A Spring boot GraphQL Service that interacts with 3 downstream Services via REST API,  Aggregates result and returns results based on Graph QL Schema Defination.
